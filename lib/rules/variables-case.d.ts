...
declare const ERROR_MESSAGE: {
    readonly [SHOULD_BE_CAMEL_CASE]: "{identifier} should be camel case";
    readonly [SHOULD_BE_SNAKE_CASE]: "{identifier} should be snake case";
    readonly [SHOULD_BE_PASCAL_CASE]: "{identifier} should be pascal case";
};
